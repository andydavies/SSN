/*
 * Auto-generated by Frida. Please modify to match the signature of CRYPTO_cbc128_encrypt.
...
{
    /**
     * Called synchronously when about to call CRYPTO_cbc128_encrypt.
     *
    ...
    onEnter(log, args, state) {
        log("CRYPTO_cbc128_encrypt(" + "" + ")" + args[2] + " " + args[3]);


	temp = Memory.readByteArray(args[0],48);
    ...
    /**
     * Called synchronously when about to return from CRYPTO_cbc128_encrypt.
     *
